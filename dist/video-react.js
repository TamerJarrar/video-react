  ...
  */
  ...
  function mergeAndSortChildren(defaultChildren, _children, _parentProps, defaultOrder) {
    ...
    var order = _parentProps.order,
        parentProps = _objectWithoutPropertiesLoose(_parentProps, _excluded); // ignore order from parent
  ...
  var Video = /*#__PURE__*/function (_Component) {
    ...
    _proto.renderChildren = function renderChildren() {
      ...
      return React__default.Children.toArray(this.props.children).filter(isVideoChild).map(function (c) {
        ...
        return /*#__PURE__*/React__default.cloneElement(c, cprops);
      });
    };
  ...
  function LoadProgressBar(_ref) {
    ...
    for (var i = 0; i < buffered.length; i++) {
      ...
      var part = /*#__PURE__*/React__default.createElement("div", {
        style: {
  ...
  var SeekBar = /*#__PURE__*/function (_Component) {
    ...
    _proto.render = function render() {
      ...
      }, /*#__PURE__*/React__default.createElement(LoadProgressBar, {
        buffered: buffered,
        currentTime: time,
        duration: duration
      }), /*#__PURE__*/React__default.createElement(MouseTimeDisplay, {
        duration: duration,
        mouseTime: mouseTime
  ...
  var ProgressControl = /*#__PURE__*/function (_Component) {
    ...
    _proto.render = function render() {
      ...
      }, /*#__PURE__*/React__default.createElement(SeekBar, _extends({
  ...
  function TimeDivider(_ref) {
    ...
    return /*#__PURE__*/React__default.createElement("div", {
      ...
      dir: "ltr"
    }, /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement("span", null, separatorText)));
  }
  ...
  function PopupButton(props) {
    ...
    delete ps.inline;
    delete ps.className;
    return /*#__PURE__*/React__default.createElement(ClickableComponent, _extends({
      className: classnames(className, {
        'video-react-menu-button-inline': !!inline,
        'video-react-menu-button-popup': !inline
      }, 'video-react-control video-react-button video-react-menu-button')
    }, ps), /*#__PURE__*/React__default.createElement(Popup, props));
  }
  ...
  var VolumeBar = /*#__PURE__*/function (_Component) {
    ...
    _proto.render = function render() {
      ...
      }), /*#__PURE__*/React__default.createElement(VolumeLevel, this.props));
    };
  ...
  var VolumeMenuButton = /*#__PURE__*/function (_Component) {
    ...
    _proto.render = function render() {
      ...
      return /*#__PURE__*/React__default.createElement(PopupButton, {
        className: classnames(className, {
        ...
        onClick: this.handleClick,
        inline: inline
      }, /*#__PURE__*/React__default.createElement(VolumeBar, _extends({
        onFocus: this.handleFocus,
        onBlur: this.handleBlur
      }, this.props)));
    };
  ...
  var MenuButton = /*#__PURE__*/function (_Component) {
    ...
    _proto.renderMenu = function renderMenu() {
      ...
      var items = this.props.items;
      return /*#__PURE__*/React__default.createElement(Menu, null, items.map(function (item, i) {
    ...
    _proto.render = function render() {
      ...
      return /*#__PURE__*/React__default.createElement(ClickableComponent, {
        className: classnames(className, {
          'video-react-menu-button-inline': !!inline,
          'video-react-menu-button-popup': !inline,
  ...
  var PlaybackRateMenuButton = /*#__PURE__*/function (_Component) {
    ...
    _proto.render = function render() {
      ...
      return /*#__PURE__*/React__default.createElement(MenuButton, {
        ...
        className: "video-react-control-text"
      }, "Playback Rate"), /*#__PURE__*/React__default.createElement("div", {
  ...
  var ControlBar = /*#__PURE__*/function (_Component) {
    ...
    _proto.getDefaultChildren = function getDefaultChildren() {
      return [/*#__PURE__*/React__default.createElement(PlayToggle, {
        key: "play-toggle",
        order: 1
      }), /*#__PURE__*/React__default.createElement(VolumeMenuButton, {
        key: "volume-menu-button",
        order: 4
      }), /*#__PURE__*/React__default.createElement(CurrentTimeDisplay, {
        key: "current-time-display",
        order: 5.1
      }), /*#__PURE__*/React__default.createElement(TimeDivider, {
        key: "time-divider",
        order: 5.2
      }), /*#__PURE__*/React__default.createElement(DurationDisplay, {
        key: "duration-display",
        order: 5.3
      }), /*#__PURE__*/React__default.createElement(ProgressControl, {
        key: "progress-control",
        order: 6
      }), /*#__PURE__*/React__default.createElement(FullscreenToggle, {
    ...
    _proto.getFullChildren = function getFullChildren() {
      return [/*#__PURE__*/React__default.createElement(PlayToggle, {
        key: "play-toggle",
        order: 1
      }), /*#__PURE__*/React__default.createElement(ReplayControl, {
        key: "replay-control",
        order: 2
      }), /*#__PURE__*/React__default.createElement(ForwardControl, {
        key: "forward-control",
        order: 3
      }), /*#__PURE__*/React__default.createElement(VolumeMenuButton, {
        key: "volume-menu-button",
        ...
        key: "progress-control",
        order: 8
      }), /*#__PURE__*/React__default.createElement(RemainingTimeDisplay, {
        key: "remaining-time-display",
        order: 9
      }), /*#__PURE__*/React__default.createElement(PlaybackRateMenuButton, {
        rates: [1, 1.25, 1.5, 2],
        key: "playback-rate",
        order: 10
      }), /*#__PURE__*/React__default.createElement(FullscreenToggle, {
    ...
    _proto.getChildren = function getChildren() {
      ...
      var _this$props = this.props,
          className = _this$props.className,
          parentProps = _objectWithoutPropertiesLoose(_this$props, _excluded$1); // remove className
    ...
    _proto.render = function render() {
      ...
      return disableCompletely ? null : /*#__PURE__*/React__default.createElement("div", {
  ...
  var Player = /*#__PURE__*/function (_Component) {
    ...
    _proto.getDefaultChildren = function getDefaultChildren(originalChildren) {
      ...
      return [/*#__PURE__*/React__default.createElement(Video, {
        ...
        key: "video",
        order: 0.0
      }, originalChildren), /*#__PURE__*/React__default.createElement(PosterImage, {
        key: "poster-image",
        order: 1.0
      }), /*#__PURE__*/React__default.createElement(LoadingSpinner, {
        key: "loading-spinner",
        order: 2.0
      }), /*#__PURE__*/React__default.createElement(Bezel, {
        key: "bezel",
        order: 3.0
      }), /*#__PURE__*/React__default.createElement(BigPlayButton, {
        key: "big-play-button",
        order: 4.0
      }), /*#__PURE__*/React__default.createElement(ControlBar, {
        key: "control-bar",
        order: 5.0
      }), /*#__PURE__*/React__default.createElement(Shortcut, {
        key: "shortcut",
        order: 99.0
      })];
    };
    ...
    _proto.getChildren = function getChildren(props) {
      var _ = props.className,
          ...
          propsWithoutChildren = _objectWithoutPropertiesLoose(props, _excluded$2);
    ...
    _proto.startControlsTimer = function startControlsTimer() {
      ...
      React__default.Children.forEach(this.props.children, function (element) {
        if (! /*#__PURE__*/React__default.isValidElement(element) || element.type !== ControlBar) {
          return;
        }
  ...
  var PlaybackRate = /*#__PURE__*/function (_Component) {
    ...
    _proto.render = function render() {
      return /*#__PURE__*/React__default.createElement(PlaybackRateMenuButton, this.props);
    };
